...
<link href="https://cdn.datatables.net/buttons/1.6.1/css/buttons.dataTables.min.css"  rel="stylesheet"> -->
  ...
  <style type="text/css">
    ...
    td,
    thead {
      font-family: <?= $this->session->userdata('font') !== NULL ? $this->session->userdata('font') : 'Lucida, sans-serif;'; ?> font-size: <?= $this->session->userdata('size_font') ?>px;
    }
