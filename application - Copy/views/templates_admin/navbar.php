								...
								<li class="nav-item dropdown">
									...
									if ($user_level == 'super_admin' || $super_admin == '1') {
										$query = "SELECT menu_hrd.KODE_MENU,
													...
													menu_hrd.`LEVEL` 
													from menu_hrd
													WHERE menu_hrd.`LEVEL`='1' AND menu_hrd.PARENT_MENU='$row0->KODE_MENU' ";
									} else {
										...
										$query = "SELECT menu_hrd.KODE_MENU, 
													...
													menu_hrd.PARENT_MENU, 
													menu_hrd.`LEVEL`, 
													user_typed_hrd.kode_menu  
													from menu_hrd
													INNER JOIN user_typed_hrd ON user_typed_hrd.kode_menu=menu_hrd.KODE_MENU 
													WHERE menu_hrd.`LEVEL`='1' and user_typed_hrd.user_level='" . $this->session->userdata["level"] . "' and menu_hrd.PARENT_MENU='$row0->KODE_MENU' and  (user_typed_hrd.lihat='1' or user_typed_hrd.baru='1' or user_typed_hrd.edit='1' ) ";
									}
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="post" action="<?php echo base_url('admin/dashboard/ganti_periode') ?>" class="user">
									...
									<div class="form-group">
										<input type="text" class="form-control form-control-user" list="fase" id="fasePeriode" placeholder="Fase..." name="fase">
										<datalist id="fase">
