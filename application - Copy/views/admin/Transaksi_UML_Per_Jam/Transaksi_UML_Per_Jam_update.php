<?php
foreach ($transaksi_uml_per_jam as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="transaksiumlperjam" name="transaksiumlperjam" action="<?php echo base_url('admin/Transaksi_UML_Per_Jam/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($transaksi_uml_per_jam as $row) :
							?>
								<tr>
...
<script>
	...
	function select_nm_peg() {
		$('.js-example-responsive-nm_peg').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_UML_Per_Jam/getDataAjax_Pegawai') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
