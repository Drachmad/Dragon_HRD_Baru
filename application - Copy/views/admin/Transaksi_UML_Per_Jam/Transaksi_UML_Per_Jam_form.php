...
<div class="container-fluid">
	...
	<form id="transaksiumlperjam" name="transaksiumlperjam" action="<?php echo base_url('admin/Transaksi_UML_Per_Jam/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
