...
<div class="container-fluid">
	...
	<form id="kikflocking" name="kikflocking" action="<?php echo base_url('admin/Transaksi_KIK_Flocking/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function tambah() {
		...
		td3.innerHTML = "<input name='TGL_KIK[]' id=TGL_KIK" + idrow + " type='text' class='date form-control TGL_KIK' data-date-format='dd-mm-yyyy' value='<?php if (isset($_POST["tampilkan"])) {
																																								echo $_POST["TGL_KIK"];
...
<script>
	...
	function select_no_kik() {
		...
		$('.js-example-responsive-no_kik').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_Flocking/getDataAjax_KIK2') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
