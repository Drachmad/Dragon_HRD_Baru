...
<div class="container-fluid">
	...
	<form id="kikcatspray" name="kikcatspray" action="<?php echo base_url('admin/Transaksi_KIK_CatSpray/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td>
									<button type="button" class="btn btn-sm btn-circle btn-outline-danger btn-deletek" onclick="">
