...
<div class="container-fluid">
	...
	<form id="kikjuki" name="kikjuki" action="<?php echo base_url('admin/Transaksi_KIK_Juki/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td><input name="SISA[]" onclick="select()" value="0" id="SISA0" type="text" class="form-control SISA rightJustified text-primary"></td>
								<td><input name="KIRIM[]" onclick="select()" value="0" id="KIRIM0" type="text" class="form-control KIRIM rightJustified text-primary"></td>
...
<script>
	...
	function tambah() {
		...
		td8.innerHTML = "<input name='SISA[]' onclick='select()' onkeyup='hitung()' value='0' id=SISA" + idrow + " type='text' class='form-control SISA rightJustified text-primary'>";
		td9.innerHTML = "<input name='KIRIM[]' onclick='select()' onkeyup='hitung()' value='0' id=KIRIM" + idrow + " type='text' class='form-control KIRIM rightJustified text-primary'>";
		td10.innerHTML = "<input name='UPAH[]' onclick='select()' onkeyup='hitung()' value='0' id=UPAH" + idrow + " type='text' class='form-control UPAH rightJustified text-primary' readonly>";
		td11.innerHTML = "<input name='JUMLAH[]' onkeyup='hitung()' value='0' id=JUMLAH" + idrow + " type='text' class='form-control JUMLAH rightJustified text-primary' readonly>";
		td12.innerHTML = "<input name='ORG[]' onkeyup='hitung()' onclick='select()' value='0' id=ORG" + idrow + " type='text' class='form-control ORG rightJustified text-primary'>";
...
<script>
	...
	function select_no_kik() {
		...
		$('.js-example-responsive-no_kik').select2({
			...
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_Juki/getDataAjax_KIK2') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
