...
<div class="container-fluid">
	...
	<form id="transaksithrharian" name="transaksithrharian" action="<?php echo base_url('admin/Transaksi_THR_Harian/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td>
									<select class="js-example-responsive-nm_peg form-control NM_PEG0 text_input" name="NM_PEG[]" id="NM_PEG0" onchange="nm_peg(this.id)" onfocusout="hitung()" readonly></select>
								</td>
