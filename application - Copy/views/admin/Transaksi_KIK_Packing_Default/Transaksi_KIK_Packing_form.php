...
<div class="container-fluid">
	...
	<form id="kikpacking" name="kikpacking" action="<?php echo base_url('admin/Transaksi_KIK_Packing/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td>
									<select class="js-example-responsive-no_kik form-control NO_KIK0" name="NO_KIK[]" id="NO_KIK0" onchange="no_kik(this.id)" onfocusout="hitung()" required></select>
								</td>
								<td>
