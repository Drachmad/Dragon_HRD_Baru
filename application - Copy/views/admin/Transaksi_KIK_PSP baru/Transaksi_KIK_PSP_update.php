						...
						<tbody id="detail">
							...
							?>
								<tr>
									...
									<td>
										<input name="TGL_KIK[]" id="TGL_KIK<?php echo $no; ?>" type="text" class="date form-control" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($row->TGL_KIK, TRUE)); ?>" onclick="select()">
									</td>
