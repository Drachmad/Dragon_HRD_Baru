...
<div class="container-fluid">
	...
	<form id="transaksitunjanganjasa" name="transaksitunjanganjasa" action="<?php echo base_url('admin/Transaksi_Tunjangan_Jasa/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="JASA[]" onkeyup="hitung()" value="0" id="JASA0" type="text" class="form-control JASA rightJustified text-primary"></td>
								<td>
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control TJASA rightJustified text-primary font-weight-bold" id="TJASA" name="TJASA" value="0" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
				...
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'<td><input name="JASA[]" onclick="select()" onkeyup="hitung()" value="0" id=JASA' + i + ' type="text" class="form-control JASA rightJustified text-primary"></td>' +
