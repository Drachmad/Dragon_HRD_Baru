...
<div class="container-fluid">
	...
	<form id="transaksitunjangannikahmati" name="transaksitunjangannikahmati" action="<?php echo base_url('admin/Transaksi_Tunjangan_Nikah_Mati/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($transaksi_tunjangan_nikah_mati as $row) :
							?>
								<tr>
									...
									<td><input name="NIKAH_MATI[]" onkeyup="hitung()" id="NIKAH_MATI<?php echo $no; ?>" value="<?php echo number_format($row->NIKAH_MATI, 2, '.', ','); ?>" type="text" class="form-control NIKAH_MATI rightJustified text-primary"></td>
									<td>
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control T_NIKAH_MATI rightJustified text-primary font-weight-bold" id="T_NIKAH_MATI" name="T_NIKAH_MATI" value="<?php echo number_format($rowh->T_NIKAH_MATI, 2, '.', ','); ?>" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
...
<script>
	...
	function tambah() {
		...
		td5.innerHTML = "<input name='NIKAH_MATI[]' onclick='select()' onkeyup='hitung()' value='0' id=NIKAH_MATI" + idrow + " type='text' class='form-control NIKAH_MATI rightJustified text-primary'>";
