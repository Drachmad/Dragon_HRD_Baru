...
<div class="container-fluid">
	...
	<form id="borongan" name="borongan" action="<?php echo base_url('admin/Transaksi_Borongan/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
						...
						<tbody id="show-data">
							<tr>
								...
								<td>
									...
									<input name="NETT[]" onchange="hitung()" value="0" id="NETT0" type="hidden" class="form-control NETT rightJustified text-primary">
				...
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'<input name="NETT[]" onchange="hitung()" id=NETT' + i + ' value="' + numberWithCommas(response[i].NETT) + '" type="hidden" class="form-control NETT rightJustified text-primary" readonly>' +
