...
<div class="container-fluid">
	...
	<form id="premiinject" name="premiinject" action="<?php echo base_url('admin/Transaksi_Premi_Inject/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="KD_BAG[]" id="KD_BAG0" type="text" class="form-control KD_BAG text_input" readonly></td>
								...
								<td>
									...
									<input name="KSMESIN[]" onkeyup="hitung()" value="0" id="KSMESIN0" type="hidden" class="form-control KSMESIN rightJustified text-primary" readonly>
...
<script>
	...
	$(document).ready(function() {
		...
		for (i = 0; i <= jumlahdata; i++) {
			...
			$("#KSMESIN" + i.toString()).autoNumeric('init', {
				aSign: '<?php echo ''; ?>',
				vMin: '-999999999.99'
			});
		...
		$('body').on('click', '.select_kik_grup', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_Premi_Inject/filter_kik_grup'); ?>',
				data: {
					kik_grup: kik_grup
				},
				dataType: 'json',
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'<td><input name="TMS[]" onclick="select()" onkeyup="hitung()" value="0" id=TMS' + i + ' type="text" class="form-control TMS rightJustified text-primary"></td>' +
							...
							'<input name="KSMESIN[]" onkeyup="hitung()" value="0" id=KSMESIN' + i + ' type="hidden" class="form-control KSMESIN rightJustified text-primary" readonly>' +
