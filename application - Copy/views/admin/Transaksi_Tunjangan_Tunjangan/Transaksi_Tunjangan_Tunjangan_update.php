...
<div class="container-fluid">
	...
	<form id="tunjangantunjangan" name="tunjangantunjangan" action="<?php echo base_url('admin/Transaksi_Tunjangan_Tunjangan/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control T_TJABATAN rightJustified text-primary font-weight-bold" id="T_TJABATAN" name="T_TJABATAN" value="<?php echo number_format($rowh->T_TJABATAN, 2, '.', ','); ?>" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
