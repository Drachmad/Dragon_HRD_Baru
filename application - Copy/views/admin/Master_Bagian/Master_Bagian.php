...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Master_Bagian/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="150px">Kode Grup</th>
                        <th width="200px">Nama Grup</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Master_Bagian/get_ajax_hrd_bag') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
