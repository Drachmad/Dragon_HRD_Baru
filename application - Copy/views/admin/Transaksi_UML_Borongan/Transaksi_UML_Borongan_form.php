...
<div class="container-fluid">
	...
	<form id="transaksiumlborongan" name="transaksiumlborongan" action="<?php echo base_url('admin/Transaksi_UML_Borongan/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="ULEMBUR[]" onkeyup="hitung()" value="0" id="ULEMBUR0" type="text" class="form-control ULEMBUR rightJustified text-primary" readonly></td>
								<td>
		...
		$('body').on('click', '.select_kd_bag', function() {
			...
			$.ajax({
				...
				success: function(response) {
					...
					jumlahdata = 100;
					for (i = 0; i <= jumlahdata; i++) {
						$("#UL" + i.toString()).autoNumeric('init', {
							aSign: '<?php echo ''; ?>',
							vMin: '-999999999.99'
						});
					}
