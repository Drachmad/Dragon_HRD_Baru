...
<div class="container-fluid">
	...
	<form id="kikjahit" name="kikjahit" action="<?php echo base_url('admin/Transaksi_KIK_Jahit/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function tambah() {
		...
		var no_kik = "<div class='input-group'><select class='js-example-responsive-no_kik form-control NO_KIK" + idrow + " text_input' name='NO_KIK[]' id='NO_KIK" + idrow + "' onchange='no_kik(this.id)' onfocusout='hitung()' required></select></div>";
