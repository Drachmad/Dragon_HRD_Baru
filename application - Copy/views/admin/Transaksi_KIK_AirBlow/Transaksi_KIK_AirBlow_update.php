						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<input name="TGL_KIK[]" id="TGL_KIK<?php echo $no; ?>" type="text" class="date form-control text_input" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($row->TGL_KIK, TRUE)); ?>" onclick="select()">
									</td>
									<!-- <td>
									<div class="input-group">
...
<script>
	...
	$(document).ready(function() {
		...
		for (i = 0; i <= jumlahdata; i++) {
			...
			$("#KA" + i.toString()).autoNumeric('init', {
				aSign: '<?php echo ''; ?>',
				vMin: '-999999999.99'
			});
			$("#KA_PRS" + i.toString()).autoNumeric('init', {
				aSign: '<?php echo ''; ?>',
				vMin: '-999999999.99'
			});
			$("#WA" + i.toString()).autoNumeric('init', {
				aSign: '<?php echo ''; ?>',
				vMin: '-999999999.99'
			});
			...
			$("#PRS" + i.toString()).autoNumeric('init', {
				aSign: '<?php echo ''; ?>',
				vMin: '-999999999.99'
			});
	...
	function tambah() {
		...
		td3.innerHTML = "<input onclick='select()' name='TGL_KIK[]' id=TGL_KIK" + idrow + " type='text' class='date form-control TGL_KIK text_input' data-date-format='dd-mm-yyyy' value='<?php if (isset($_POST["tampilkan"])) {
																																																echo $_POST["TGL_KIK"];
