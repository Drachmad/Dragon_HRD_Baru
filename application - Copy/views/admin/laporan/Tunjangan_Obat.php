...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Tunjangan Obat
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="tunjanganobat" method="post" action="<?php echo base_url('admin/laporan/index_Tunjangan_Obat') ?>">
            <div class="col-md-12">
