...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Insentif Per Bagian
        </div>
        ...
        <form id="insentif_perbagian" method="post" action="<?php echo base_url('admin/laporan/index_Insentif_PerBagian') ?>">
            <!-- <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input type="text" value="<?= $PER2 ?>" class="form-control form-control-user text_input" id="PER2" placeholder="mm/yyyy" name="PER2">
                    </div>
                    <div class="col-md-1">
                    ...
                    <div class="col-md-2">
                        <select class="js-example-responsive form-control KD_BAG_2 text_input" name="KD_BAG_2" id="KD_BAG_2" style="width: 100%;">
                            <?php
