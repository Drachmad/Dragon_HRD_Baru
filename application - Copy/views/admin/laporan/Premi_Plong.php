...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Premi Plong
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="premiplong" method="post" action="<?php echo base_url('admin/laporan/index_Premi_Plong') ?>">
            <div class="col-md-12">
