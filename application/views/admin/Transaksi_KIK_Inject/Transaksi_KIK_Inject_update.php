<?php
	foreach ($transaksi_kik_inject as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="transaksikikinject" name="transaksikikinject" action="<?php echo base_url('admin/Transaksi_KIK_Inject/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2 input-group">
							<input name="KD_BAG" id="KD_BAG" maxlength="30" value="<?php echo $rowh->KD_BAG ?>" type="text" class="form-control KD_BAG text_input" onkeypress="return tabE(this,event)" readonly>
						...
						<div class="col-md-2">
							<input class="form-control text_input NM_BAG" id="NM_BAG" name="NM_BAG" value="<?php echo $rowh->NM_BAG ?>" type="text" readonly>
							<input class="form-control text_input KD_GRUP" id="KD_GRUP" name="KD_GRUP" value="<?php echo $rowh->KD_GRUP ?>" type="hidden" readonly>
							<input class="form-control text_input NM_GRUP" id="NM_GRUP" name="NM_GRUP" value="<?php echo $rowh->NM_GRUP ?>" type="hidden" readonly>
						</div>
						<div class="col-md-2">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-3">
							<input type="hidden" class="form-control UMR rightJustified text-primary font-weight-bold" id="UMR" name="UMR" value="<?php echo number_format($rowh->UMR, 2, '.', ','); ?>" readonly>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<?php
							$no = 0;
							foreach ($transaksi_kik_inject as $row) : 
						?>
							<tr>
								...
								<td><input name="KG[]" onclick="select()" onkeyup="hitung()" id="KG<?php echo $no; ?>" value="<?php echo number_format($row->KG, 2, '.', ','); ?>" type="text" class="form-control KG rightJustified text-primary"></td>
								...
								<td><input name="OT[]" onclick="select()" onkeyup="hitung()" id="OT<?php echo $no; ?>" value="<?php echo number_format($row->OT, 2, '.', ','); ?>" type="text" class="form-control OT rightJustified text-primary"></td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">						
					<input class="form-control PPN rightJustified text-danger font-weight-bold" id="PPN" value="<?php echo number_format($rowh->PPN, 2, '.', ','); ?>" name="PPN" readonly>
				</div>
			</div>
		</div>
		<div class="col-md-12">
...
<script>
	...
	$(document).ready(function() {
		...
		for (i = 0; i <= jumlahdata; i++) {
			...
			$("#OT" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
	...
	function hitung() {
		...
		for (i=0;i<total_row;i++) {
			...
			var kg = parseFloat($('#KG'+i).val().replace(/,/g, ''));
			var org = parseFloat($('#ORG'+i).val().replace(/,/g, ''));
			var ot = parseFloat($('#OT'+i).val().replace(/,/g, ''));
			...
			hr = ((kg*110417)+(org*104167)+(ot*103124)) - jumlah;
			hr = hr.toFixed(2);
			if(isNaN(hr)) hr = 0;
	...
	function tambah() {
		...
		td10.innerHTML = "<input name='KG[]' onkeyup='hitung()' onclick='select()' value='0' id=KG" + idrow + " type='text' class='form-control KG rightJustified text-primary'>";
		td11.innerHTML = "<input name='ORG[]' onkeyup='hitung()' onclick='select()' value='0' id=ORG" + idrow + " type='text' class='form-control ORG rightJustified text-primary'>";
		td12.innerHTML = "<input name='OT[]' onkeyup='hitung()' onclick='select()' value='0' id=OT" + idrow + " type='text' class='form-control OT rightJustified text-primary'>";
		td13.innerHTML = "<input name='HR[]' onkeyup='hitung()' value='0' id=HR" + idrow + " type='text' class='form-control HR rightJustified text-primary' readonly>";
...
// NO_KIK
	function select_no_kik() {
		...
		$('.js-example-responsive-no_kik').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_Inject/getDataAjax_KIK2') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
