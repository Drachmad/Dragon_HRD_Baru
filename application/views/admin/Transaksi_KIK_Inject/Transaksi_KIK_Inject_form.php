...
<div class="container-fluid">
	...
	<form id="kikinject" name="kikinject" action="<?php echo base_url('admin/Transaksi_KIK_Inject/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td><input name="KG[]" onclick="select()" onkeyup="hitung()" value="0" id="KG0" type="text" class="form-control KG rightJustified text-primary"></td>
								...
								<td><input name="OT[]" onclick="select()" onkeyup="hitung()" value="0" id="OT0" type="text" class="form-control OT rightJustified text-primary"></td>
...
<script>
	...
	function tambah() {
		...
		td14.innerHTML = "<input type='hidden' name='NO_ID[]' id=NO_ID" + idrow + "  class='form-control' value='0'>" +
