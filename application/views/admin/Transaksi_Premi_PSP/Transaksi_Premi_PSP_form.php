...
<div class="container-fluid">
	...
	<form id="premipsp" name="premipsp" action="<?php echo base_url('admin/Transaksi_Premi_PSP/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="BON_BARU[]" onkeyup="hitung()" value="0" id="BON_BARU0" type="text" class="form-control BON_BARU rightJustified text-primary"></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_kik_grup', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Premi_PSP/filter_kik_grup'); ?>',
				...
				// alert(response);
                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'<td><input name="LAIN[]" onclick="select()" onkeyup="hitung()" id=LAIN'+i+' value="0" type="text" class="form-control LAIN rightJustified text-primary"></td>'+
									'<td>'+
