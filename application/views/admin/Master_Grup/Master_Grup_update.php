...
<div class="container-fluid">
    ...
    <div class="alert alert-success alert-container" role="alert">
        <i class="fas fa-university"></i> Update Master Grup
    </div>
	<form id="form_master_grup" name="form_master_grup" action="<?php echo base_url('admin/Master_Grup/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
        <br><br>
        <div class="form-body">
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						...
						<input type="text" id="KD_GRUP" name="KD_GRUP" class="form-control text_input KD_GRUP" value="<?= $KD_GRUP ?>">
					</div>
                    <div class="col-md-1">
						<label class="label">Nama Grup</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="NM_GRUP" name="NM_GRUP" class="form-control text_input NM_GRUP" value="<?= $NM_GRUP ?>">
					</div>
					<div class="col-md-1">
						<label class="label">Acno</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="ACNO" name="ACNO" class="form-control text_input ACNO" value="<?= $ACNO ?>">
					</div>
				</div>
			</div>
        </div>
			...
			<div class="col-xs-9">
				<div class="wells">		
					<div class="btn-group">
						...
						<a type="button" href="<?php echo base_url('admin/Master_Grup/index_Master_Grup') ?>" class="btn btn-danger btn_cancel">Cancel</a>
					</div>
					<h4>
