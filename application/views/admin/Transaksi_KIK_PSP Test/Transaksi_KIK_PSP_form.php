...
<div class="container-fluid">
	...
	<form id="kikpsp" name="kikpsp" action="<?php echo base_url('admin/Transaksi_KIK_PSP/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td>
									<select class="js-example-responsive-no_kik form-control NO_KIK0 text_input" name="NO_KIK[]" id="NO_KIK0" onchange="no_kik(this.id)" onfocusout="hitung()"></select>
								</td>
								<td>
									<input 
										type="text" 
									...
									>
								<td>
									<select class="js-example-responsive-model form-control MODEL0 text_input" name="MODEL[]" id="MODEL0" onchange="model(this.id)" onfocusout="hitung()"></select>
								</td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				<div class="col-md-5 ">						
					...
					<div class="col-md-2 ">
						<input class="form-control LUNAS_BS rightJustified text-primary font-weight-bold" onclick="select()" onkeyup="hitung()" id="LUNAS_BS" name="LUNAS_BS" value="0">
					</div>
				</div>
			</div>
			<div class="col-md-12">
