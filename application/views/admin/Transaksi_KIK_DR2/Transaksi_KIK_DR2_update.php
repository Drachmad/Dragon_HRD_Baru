...
<div class="container-fluid">
	...
	<form id="kikdr2" name="kikdr2" action="<?php echo base_url('admin/Transaksi_KIK_DR2/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						?>
							<tr>
                                ...
                                <td><input name="MODEL[]" id="MODEL<?php echo $no; ?>" value="<?= $row->MODEL ?>" type="text" class="form-control MODEL text_input"></td>
								<td><input name="ITEM[]" id="ITEM<?php echo $no; ?>" value="<?= $row->ITEM ?>" type="text" class="form-control ITEM text_input"></td>
								<td><input name="DES1[]" id="DES1<?php echo $no; ?>" value="<?= $row->DES1 ?>" type="text" class="form-control DES1 text_input"></td>
								...
								<td><input name="UPAH[]" onkeyup="hitung()" id="UPAH<?php echo $no; ?>" value="<?php echo number_format($row->UPAH, 2, '.', ','); ?>" type="text" class="form-control UPAH rightJustified text-primary"></td>
								<td><input name="JUMLAH[]" onkeyup="hitung()" id="JUMLAH<?php echo $no; ?>" value="<?php echo number_format($row->JUMLAH, 2, '.', ','); ?>" type="text" class="form-control JUMLAH rightJustified text-primary"></td>
								...
								<td><input name="HR[]" onkeyup="hitung()" id="HR<?php echo $no; ?>" value="<?php echo number_format($row->HR, 2, '.', ','); ?>" type="text" class="form-control HR rightJustified text-primary"></td>
								<td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control PPN rightJustified text-danger font-weight-bold" id="PPN" name="PPN" value="<?php echo number_format($rowh->PPN, 2, '.', ','); ?>">
				</div>
				<div class="col-md-1 ">
					<label class="label">Minuss </label>
				</div>
				<div class="col-md-2 ">						
					<input class="form-control MINUSS rightJustified text-danger font-weight-bold" id="MINUSS" name="MINUSS" value="<?php echo number_format($rowh->MINUSS, 2, '.', ','); ?>">
				</div>
			</div>
		</div>
		<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-2 ">
                        <input class="form-control POT_BON rightJustified text-primary font-weight-bold" id="POT_BON" name="POT_BON" value="<?php echo number_format($rowh->POT_BON, 2, '.', ','); ?>">
					</div>
				</div>
			</div>
		<div class="row">
...
<script>
	...
	function hitung() {
		...
		var PPN = parseFloat($('#LUNAS_BS').val().replace(/,/g, ''));
		var MINUSS = parseFloat($('#MINUSS').val().replace(/,/g, ''));
		var POT_BON = parseFloat($('#POT_BON').val().replace(/,/g, ''));
		var umr = 104167;
		var umrd = 104167;
	...
	function tambah() {
		...
		var no_kik0 = "<div class='input-group'><select class='js-example-responsive-no_kik form-control NO_KIK0 text_input' name='NO_KIK[]' id=NO_KIK" + idrow + " onchange='no_kik(this.id)' onfocusout='hitung()'></select></div>";
		var no_kik = no_kik0;
		...
		td2.innerHTML = "<input name='NO_KIK[]' id=NO_KIK" + idrow + " type='text' class='form-control NO_KIK text_input'>";
		...
		// td4.innerHTML = model;
		td4.innerHTML = "<input name='MODEL[]' id=MODEL" + idrow + " type='text' class='form-control MODEL text_input'>";
		td5.innerHTML = "<input name='ITEM[]' id=ITEM" + idrow + " type='text' class='form-control ITEM text_input'>";
		td6.innerHTML = "<input name='DES1[]' id=DES1" + idrow + " type='text' class='form-control DES1 text_input'>";
		...
		td8.innerHTML = "<input name='UPAH[]' onclick='select()' onkeyup='hitung()' value='0' id=UPAH" + idrow + " type='text' class='form-control UPAH rightJustified text-primary'>";
		td9.innerHTML = "<input name='JUMLAH[]' onkeyup='hitung()' value='0' id=JUMLAH" + idrow + " type='text' class='form-control JUMLAH rightJustified text-primary'>";
		...
		td11.innerHTML = "<input name='HR[]' onkeyup='hitung()' value='0' id=HR" + idrow + " type='text' class='form-control HR rightJustified text-primary'>";
...
// NO_KIK
	function select_no_kik() {
		$('.js-example-responsive-no_kik').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_DR2/getDataAjax_KIK') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
...
// MODEL
	function select_model() {
		...
		$('.js-example-responsive-model').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_DR2/getDataAjax_Model') ?>",
				dataType: "json",
