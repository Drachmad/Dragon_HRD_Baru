...
<div class="container-fluid">
	...
	<form id="kikdr2" name="kikdr2" action="<?php echo base_url('admin/Transaksi_KIK_DR2/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td><input name="NO_KIK[]" id="NO_KIK0" type="text" class="form-control NO_KIK text_input"></td>
								<td>
									<input 
										type="text" 
								...
								<td><input name="MODEL[]" id="MODEL0" type="text" class="form-control MODEL text_input"></td>
								<td><input name="ITEM[]" id="ITEM0" type="text" class="form-control ITEM text_input"></td>
								<td><input name="DES1[]" id="DES10" type="text" class="form-control DES1 text_input"></td>
								...
								<td><input name="UPAH[]" onkeyup="hitung()" value="0" id="UPAH0" type="text" class="form-control UPAH rightJustified text-primary"></td>
								<td><input name="JUMLAH[]" onkeyup="hitung()" value="0" id="JUMLAH0" type="text" class="form-control JUMLAH rightJustified text-primary"></td>
								...
								<td><input name="HR[]" onkeyup="hitung()" value="0" id="HR0" type="text" class="form-control HR rightJustified text-primary"></td>
								<td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">
					<input class="form-control PPN rightJustified text-danger font-weight-bold" id="PPN" name="PPN" value='0'>
				</div>
				<div class="col-md-1 ">
					<label class="label">Minuss </label>
				</div>
				<div class="col-md-2 ">
					<input class="form-control MINUSS rightJustified text-danger font-weight-bold" id="MINUSS" name="MINUSS" value='0'>
				</div>
			</div>
		</div>
		<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-2 ">						
						<input class="form-control POT_BON rightJustified text-primary font-weight-bold" id="POT_BON" name="POT_BON" value="0">
					</div>
				</div>
			</div>
		<div class="row">
