                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'<td>'+
										...
										'<input name="TARIF1[]" onchange="hitung()" id=TARIF1'+i+' value="'+numberWithCommas(response[i].TARIF1)+'" type="text" class="form-control TARIF1 rightJustified text-primary" readonly>'+
										'<input name="TARIF2[]" onchange="hitung()" id=TARIF2'+i+' value="'+numberWithCommas(response[i].TARIF2)+'" type="text" class="form-control TARIF2 rightJustified text-primary" readonly>'+
									'</td>'+
