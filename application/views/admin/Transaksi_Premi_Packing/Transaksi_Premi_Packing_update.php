<?php
	foreach ($transaksi_premi_packing as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="premipacking" name="premipacking" action="<?php echo base_url('admin/Transaksi_Premi_Packing/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<?php
							$no = 0;
							foreach ($transaksi_premi_packing as $row) : 
						?>
							<tr>
								...
								<td><input name="REPACK[]" onclick="select()" onkeyup="hitung()" id="REPACK<?php echo $no; ?>" value="<?php echo number_format($row->REPACK, 2, '.', ','); ?>" type="text" class="form-control REPACK rightJustified text-primary"></td>
...
<script>
	...
	$(document).ready(function() {
		...
		for (i = 0; i <= jumlahdata; i++) {
			...
			$("#REPACK" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
			...
			$("#LAIN1" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
	...
	function tambah() {
		...
		td6.innerHTML = "<input name='REPACK[]' onclick='select()' onkeyup='hitung()' value='0' id=REPACK" + idrow + " type='text' class='form-control REPACK rightJustified text-primary'>";
		td7.innerHTML = "<input name='LUNAS_BS[]' onkeyup='hitung()' value='0' id=LUNAS_BS" + idrow + " type='text' class='form-control LUNAS_BS rightJustified text-primary'>";
		td8.innerHTML = "<input name='BON_BARU[]' onclick='select()' onkeyup='hitung()' value='0' id=BON_BARU" + idrow + " type='text' class='form-control BON_BARU rightJustified text-primary'>";
		...
		td10.innerHTML = "<input name='LAIN[]' onclick='select()' onkeyup='hitung()' value='0' id=LAIN" + idrow + " type='text' class='form-control LAIN rightJustified text-primary'>";
		...
		td12.innerHTML = "<input name='TNB[]' onkeyup='hitung()' value='0' id=TNB" + idrow + " type='text' class='form-control TNB rightJustified text-primary' readonly>";
		...
		td14.innerHTML = "<input name='NETTO[]' onkeyup='hitung()' value='0' id=NETTO" + idrow + " type='text' class='form-control NETTO rightJustified text-primary' readonly>";
