...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Transaksi_UML_Per_Jam/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_UML_Per_Jam/get_ajax_hrd_lem') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
