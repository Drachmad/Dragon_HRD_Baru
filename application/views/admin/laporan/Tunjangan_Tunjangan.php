...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Tunjangan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="tunjangan" method="post" action="<?php echo base_url('admin/laporan/index_Tunjangan_Tunjangan') ?>">
            <div class="col-md-12">
