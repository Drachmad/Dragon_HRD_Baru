...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Lembur Per Bagian Borongan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="lemburperbagianborongan" method="post" action="<?php echo base_url('admin/laporan/index_LemburPerBagian_Borongan') ?>">
            <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $lemburperbagian_borongan,
                    "name" => "example",
                    "showFooter"=>true,
                    "showFooter"=>"bottom",
                    "columns" => array(
