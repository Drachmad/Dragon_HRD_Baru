...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Karyawan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="karyawan" method="post" action="<?php echo base_url('admin/laporan/index_Karyawan') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1">
                        <label class="label-title">Kode </label>
                        </div>
                    <div class="col-md-3">
                        <select class="js-example-responsive form-control KD_PEG_1" name="KD_PEG_1" id="KD_PEG_1" style="width: 100%;">
                            <?php
                            if (isset($_POST["tampilkan"]) &&  $_POST["KD_PEG_1"] == $KD_PEG_1) {
                                echo '<option value="' . $KD_PEG_1 . '" selected >' . $KD_PEG_1 . '</option>';
                            } ?>
                        </select>
                    </div>
                    <div class="col-md-1">
                    ...
                    <div class="col-md-3">
                        <select class="js-example-responsive form-control KD_PEG_2" name="KD_PEG_2" id="KD_PEG_2" style="width: 100%;">
                            <?php
                            if (isset($_POST["tampilkan"]) &&  $_POST["KD_PEG_2"] == $KD_PEG_2) {
                                echo '<option value="' . $KD_PEG_2 . '" selected >' . $KD_PEG_2 . '</option>';
                            } ?>
                        </select>
                    </div>
                </div>
...
<script>
    ...
    function select_pegawai_1() {
        $('#KD_PEG_1').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_master_pegawai_1') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
    ...
    function select_pegawai_2() {
        $('#KD_PEG_2').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_master_pegawai_2') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
                data: function(params) {
