...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan THR Per Bagian
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="thrperbagian" method="post" action="<?php echo base_url('admin/laporan/index_THR_PerBagian') ?>">
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="dropdown col-sm-2 nopadding">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <!-- <a target="_blank" href="./Cetak_Insentif.php">Cetak Laporan</a> -->
                        </div>
                    </div>
                </div>
            </div>
