...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Gaji Harian
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="gaji_harian" method="post" action="<?php echo base_url('admin/laporan/index_Gaji_Harian') ?>">
            <div class="col-md-12">
