...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Premi Jahit
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="premijahit" method="post" action="<?php echo base_url('admin/laporan/index_Premi_Jahit') ?>">
            <div class="col-md-12">
