...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Premi Packing
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="premipacking" method="post" action="<?php echo base_url('admin/laporan/index_Premi_Packing') ?>">
            <div class="col-md-12">
