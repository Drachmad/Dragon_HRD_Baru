...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Gaji Harian Per Grup
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="gaji_harianpergrup" method="post" action="<?php echo base_url('admin/laporan/index_Gaji_HarianPerGrup') ?>">
            <div class="col-md-12">
