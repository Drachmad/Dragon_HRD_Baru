...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Insentif Per Grup
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="insentifpergrup" method="post" action="<?php echo base_url('admin/laporan/index_Insentif_PerGrup') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-md-1">
                        <label class="label-title">Grup </label>
                        </div>
                    <div class="col-md-3">
