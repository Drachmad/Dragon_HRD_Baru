...
<div class="container-fluid">
	...
	<form id="umlharian" name="umlharian" action="<?php echo base_url('admin/Transaksi_UML_Harian/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="ULEMBUR[]" onkeyup="hitung()" value="0" id="ULEMBUR0" type="text" class="form-control ULEMBUR rightJustified text-primary"></td>
								<td>
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control T_ULEMBUR rightJustified text-primary font-weight-bold" id="T_ULEMBUR" name="T_ULEMBUR" value="0" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
