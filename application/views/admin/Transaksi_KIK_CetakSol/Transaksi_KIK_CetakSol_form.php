...
<div class="container-fluid">
	...
	<form id="kikcetaksol" name="kikcetaksol" action="<?php echo base_url('admin/Transaksi_KIK_CetakSol/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td>
									<select value="" class="js-example-responsive-no_kik form-control NO_KIK0 text_input" name="NO_KIK[]" id="NO_KIK0" onchange="no_kik(this.id)" onfocusout="hitung()" required></select>
								</td>
								<td>
									<input 
										type="text" 
