...
<div class="container-fluid">
	...
	<form id="kikplong" name="kikplong" action="<?php echo base_url('admin/Transaksi_KIK_Plong/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
