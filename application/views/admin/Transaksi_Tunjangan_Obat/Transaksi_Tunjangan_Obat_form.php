...
<div class="container-fluid">
	...
	<form id="transaksitunjanganobat" name="transaksitunjanganobat" action="<?php echo base_url('admin/Transaksi_Tunjangan_Obat/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="OBAT[]" onkeyup="hitung()" value="0" id="OBAT0" type="text" class="form-control OBAT rightJustified text-primary"></td>
								<td>
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control TOBAT rightJustified text-primary font-weight-bold" id="TOBAT" name="TOBAT" value="0" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
				...
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'</td>' +
							'<td><input name="OBAT[]" onclick="select()" onkeyup="hitung()" value="0" id=OBAT' + i + ' type="text" class="form-control OBAT rightJustified text-primary"></td>' +
