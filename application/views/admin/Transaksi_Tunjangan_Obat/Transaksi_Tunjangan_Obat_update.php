<?php
foreach ($transaksi_tunjangan_obat as $rowh) {
};
?>
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control TOBAT rightJustified text-primary font-weight-bold" id="TOBAT" name="TOBAT" value="<?php echo number_format($row->TOBAT, 2, '.', ','); ?>" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_kd_bag', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_Tunjangan_Obat/filter_kd_bag'); ?>',
				data: {
					kd_bag: kd_bag
				},
				dataType: 'json',
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'</td>' +
							'<td><input name="OBAT[]" onkeyup="hitung()" value="0" id=OBAT' + i + ' type="text" class="form-control OBAT rightJustified text-primary"></td>' +
	...
	function tambah() {
		...
		td4.innerHTML = "<input name='OBAT[]' onclick='select()' onkeyup='hitung()' value='0' id=OBAT" + idrow + " type='text' class='form-control OBAT rightJustified text-primary'>";
