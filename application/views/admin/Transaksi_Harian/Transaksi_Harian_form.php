...
<div class="container-fluid">
	...
	<form id="transaksiharian" name="transaksiharian" action="<?php echo base_url('admin/Transaksi_Harian/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<label class="label"><label style="color: red;">*</label>jumlah = harian+(jam1rp+jam2rp) </label>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<label class="label"><label style="color: red;">*</label>jam1rp = jam1*(nett*25/173*1.5) </label>
						</div>
						<div class="col-md-2">
							<label class="label"><label style="color: red;">*</label>jam2rp = jam2*(nett*25/173*2) </label>
						</div>
						<div class="col-md-2">
							<label class="label"><label style="color: red;">*</label>harian = hr*(nett+lain) </label>
						</div>
						<div class="col-md-2">
...
<script>
				...
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'<td><input name="PO[]" onclick="select()" onkeyup="hitung()" value="0" id=POT' + i + ' type="text" class="form-control POT rightJustified text-danger"></td>' +
	...
	function tambah() {
		...
		td5.innerHTML = "<input name='HR[]' onclick='select()' onkeyup='hitung()' value='0' id=HR" + idrow + " type='text' class='form-control HR rightJustified text-primary'>";
		td6.innerHTML = "<input name='JAM1THL[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM1THL" + idrow + " type='text' class='form-control JAM1THL rightJustified text-primary'>";
		td7.innerHTML = "<input name='JAM2THL[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM2THL" + idrow + " type='text' class='form-control JAM2THL rightJustified text-primary'>";
		td8.innerHTML = "<input name='JAM1RPTHL[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM1RPTHL" + idrow + " type='text' class='form-control JAM1RPTHL rightJustified text-primary' readonly>";
		td9.innerHTML = "<input name='JAM2RPTHL[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM2RPTHL" + idrow + " type='text' class='form-control JAM2RPTHL rightJustified text-primary' readonly>";
		td10.innerHTML = "<input name='JAM1[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM1" + idrow + " type='text' class='form-control JAM1 rightJustified text-primary'>";
		td11.innerHTML = "<input name='JAM2[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM2" + idrow + " type='text' class='form-control JAM2 rightJustified text-primary'>";
		td12.innerHTML = "<input name='JAM1RP[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM1RP" + idrow + " type='text' class='form-control JAM1RP rightJustified text-primary' readonly>";
		td13.innerHTML = "<input name='JAM2RP[]' onclick='select()' onkeyup='hitung()' value='0' id=JAM2RP" + idrow + " type='text' class='form-control JAM2RP rightJustified text-primary' readonly>";
		td14.innerHTML = "<input name='LAIN[]' onclick='select()' onkeyup='hitung()' value='0' id=LAIN" + idrow + " type='text' class='form-control LAIN rightJustified text-primary'>";
		td15.innerHTML = "<input name='POT[]' onclick='select()' onkeyup='hitung()' value='0' id=POT" + idrow + " type='text' class='form-control POT rightJustified text-danger'>";
		td16.innerHTML = "<input name='TPERBULAN[]' onclick='select()' onkeyup='hitung()' value='0' id=TPERBULAN" + idrow + " type='text' class='form-control TPERBULAN rightJustified text-primary' readonly>";
		td17.innerHTML = "<input name='JUMLAH[]' onclick='select()' onkeyup='hitung()' value='0' id=JUMLAH" + idrow + " type='text' class='form-control JUMLAH rightJustified text-primary' readonly>";
		td18.innerHTML = "<input type='hidden' name='NO_ID[]' id=NO_ID" + idrow + "  class='form-control'>" +
