				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control TJASA rightJustified text-primary font-weight-bold" id="TJASA" name="TJASA" value="<?php echo number_format($row->TJASA, 2, '.', ','); ?>" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_kd_bag', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_Tunjangan_Jasa/filter_kd_bag'); ?>',
				data: {
					kd_bag: kd_bag
				},
				dataType: 'json',
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'</td>' +
							'<td><input name="JASA[]" onkeyup="hitung()" value="0" id=JASA' + i + ' type="text" class="form-control JASA rightJustified text-primary"></td>' +
	...
	function tambah() {
		...
		td4.innerHTML = "<input name='JASA[]' onclick='select()' onkeyup='hitung()' value='0' id=JASA" + idrow + " type='text' class='form-control JASA rightJustified text-primary'>";
