...
<section>
    ...
    <div class="container-fliud mx-4">
        <div class="alert alert-success alert-container" role="alert">
            ...
            <label>
                Master Status Borongan
            </label>
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form method="post" action="<?php echo base_url('admin/Master_Status_Borongan/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="75px">No</th>
                        <th width="150px">Kode Bagian</th>
                        <th width="200px">Nama Bagian</th>
                        <th width="150px">Status</th>
                        <th width="150px">Pk</th>
                        <th width="150px">Pk + Ph</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Master_Status_Borongan/get_ajax_hrd_bor') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
