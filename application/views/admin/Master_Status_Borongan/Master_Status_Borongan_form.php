...
<div class="container-fluid">
	...
	<form id="form_master_customer" name="form_master_customer" action="<?php echo base_url('admin/Master_Status_Borongan/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
        <br><br>
        <div class="form-body">
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="STAT" name="STAT" class="form-control text_input STAT">
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="PK" name="PK" class="form-control text_input PK num">
					</div>
					<div class="col-md-1">
						<label class="label">PK + PH</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="PKPH" name="PKPH" class="form-control text_input PKPH num">
					</div>
				</div>
			</div>
        </div>
