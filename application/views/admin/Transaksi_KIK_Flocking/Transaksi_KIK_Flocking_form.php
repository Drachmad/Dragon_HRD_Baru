...
<div class="container-fluid">
	...
	<form id="kikflocking" name="kikflocking" action="<?php echo base_url('admin/Transaksi_KIK_Flocking/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
						...
						<tbody>
							<tr>
								...
								<td>
									<input 
										type="text" 
										class="date form-control TGL_KIK" 
										id="TGL_KIK0" 
										name="TGL_KIK[]" 
								...
								<td><input name="MODEL[]" id="MODEL0" type="text" class="form-control MODEL" readonly></td>
								<td><input name="ITEM[]" id="ITEM0" type="text" class="form-control ITEM" readonly></td>
								<td><input name="DES1[]" id="DES10" type="text" class="form-control DES1" readonly></td>
