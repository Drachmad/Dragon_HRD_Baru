...
<div class="container-fluid">
	...
	<form id="kikmicro" name="kikmicro" action="<?php echo base_url('admin/Transaksi_KIK_Micro/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
