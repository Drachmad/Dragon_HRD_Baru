...
<div class="container-fluid">
	...
	<form id="transaksiharian" name="transaksiharian" action="<?php echo base_url('admin/Transaksi_Harian_N1/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><input name="JAM1THL[]" onclick="select()" onchange="hitung()" id="JAM1THL<?php echo $no; ?>" value="<?php echo number_format($row->JAM1THL, 2, '.', ','); ?>" type="text" class="form-control JAM1THL rightJustified text-primary"></td>
									<td><input name="JAM2THL[]" onclick="select()" onchange="hitung()" id="JAM2THL<?php echo $no; ?>" value="<?php echo number_format($row->JAM2THL, 2, '.', ','); ?>" type="text" class="form-control JAM2THL rightJustified text-primary"></td>
									<td><input name="JAM1RPTHL[]" onchange="hitung()" id="JAM1RPTHL<?php echo $no; ?>" value="<?php echo number_format($row->JAM1RPTHL, 2, '.', ','); ?>" type="text" class="form-control JAM1RPTHL rightJustified text-primary" readonly></td>
									<td><input name="JAM2RPTHL[]" onchange="hitung()" id="JAM2RPTHL<?php echo $no; ?>" value="<?php echo number_format($row->JAM2RPTHL, 2, '.', ','); ?>" type="text" class="form-control JAM2RPTHL rightJustified text-primary" readonly></td>
						...
						<tfoot>
							...
							<td><input class="form-control TJAM1THL rightJustified text-primary font-weight-bold" id="TJAM1THL" name="TJAM1THL" value="<?php echo number_format($row->TJAM1THL, 2, '.', ','); ?>" readonly></td>
							<td><input class="form-control TJAM2THL rightJustified text-primary font-weight-bold" id="TJAM2THL" name="TJAM2THL" value="<?php echo number_format($row->TJAM2THL, 2, '.', ','); ?>" readonly></td>
							<td><input class="form-control TJAM1RPTHL rightJustified text-primary font-weight-bold" id="TJAM1RPTHL" name="TJAM1RPTHL" value="<?php echo number_format($row->TJAM1RPTHL, 2, '.', ','); ?>" readonly></td>
							<td><input class="form-control TJAM2RPTHL rightJustified text-primary font-weight-bold" id="TJAM2RPTHL" name="TJAM2RPTHL" value="<?php echo number_format($row->TJAM2RPTHL, 2, '.', ','); ?>" readonly></td>
