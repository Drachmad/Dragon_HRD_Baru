...
<div class="container-fluid">
	...
	<form id="kikairblow" name="kikairblow" action="<?php echo base_url('admin/Transaksi_KIK_AirBlow/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function tambah() {
		...
		var no_kik0 = "<div class='input-group'><select class='js-example-responsive-no_kik form-control NO_KIK' name='NO_KIK[]' value='' id=NO_KIK" + idrow + " onchange='no_kik(this.id)' onfocusout='hitung()' required></select></div>";
		var no_kik = no_kik0;
		...
		td3.innerHTML = "<input onclick='select()' name='TGL_KIK[]' id=TGL_KIK" + idrow + " type='text' class='date form-control TGL_KIK text_input' data-date-format='dd-mm-yyyy' value='<?php if(isset($_POST["tampilkan"])) { echo $_POST["TGL_KIK"]; } else echo date('d-m-Y'); ?>'>";
		// td4.innerHTML = model;
...
// NO_KIK
	function select_no_kik() {
		...
		$('.js-example-responsive-no_kik').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_Airblow/getDataAjax_KIK2') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
