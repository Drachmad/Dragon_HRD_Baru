...
<div class="container-fluid">
	...
	<form id="kikairblow" name="kikairblow" action="<?php echo base_url('admin/Transaksi_KIK_AirBlow/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td>
									<select value="" class="js-example-responsive-no_kik form-control NO_KIK0" name="NO_KIK[]" id="NO_KIK0" onchange="no_kik(this.id)" onfocusout="hitung()" required></select>
								</td>
								<td>
									<input 
										type="text" 
										...
										value="<?php if(isset($_POST["tampilkan"])) { echo $_POST["TGL_KIK"]; } else echo date('d-m-Y'); ?>"
									>
								</td>
								<!-- <td>
								...
								<td><input name="KA[]" onclick="select()" onkeyup="hitung()" value="0" id="KA0" type="text" class="form-control KA rightJustified text-primary"></td>
								<td><input name="KA_PRS[]" onclick="select()" onkeyup="hitung()" value="0" id="KA_PRS0" type="text" class="form-control KA_PRS rightJustified text-primary"></td>
								<td><input name="WA[]" onclick="select()" onkeyup="hitung()" value="0" id="WA0" type="text" class="form-control WA rightJustified text-primary"></td>
								...
								<td><input name="PRS[]" onclick="select()" onkeyup="hitung()" value="0" id="PRS0" type="text" class="form-control PRS rightJustified text-primary"></td>
		...
		<div class="col-md-12">
			<div class="form-group row">
				...
				<div class="col-md-2 ">						
					<input class="form-control LEM_JAM rightJustified text-primary font-weight-bold" onclick="select()" onkeyup="hitung()" id="LEM_JAM" name="LEM_JAM" value="0">
				</div>
			</div>
		</div>
		<div class="col-md-12">
...
<script>
	...
	function tambah() {
		...
		var model0 = "<div class='input-group'><select class='js-example-responsive-model form-control MODEL0' name='MODEL[]' id=MODEL" + idrow + " onchange='model(this.id)' onfocusout='hitung()' required></select></div>";
		var model = model0;
