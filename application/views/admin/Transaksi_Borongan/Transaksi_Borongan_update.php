						...
						?>
							<tr>
								...
								<td>
									...
									<input name="NM_PEG[]" id="NM_PEG<?php echo $no; ?>" value="<?= $row->NM_PEG ?>" type="text" class="form-control NM_PEG text_input" readonly>
								</td>
...
<script>
				...
				// alert(response);
                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'</td>'+
									'<td><input name="PTKP[]" id=PTKP'+i+' type="text" class="form-control PTKP text_input"></td>'+
	...
	function tambah() {
		...
		td4.innerHTML = "<input name='PTKP[]' id=PTKP0" + idrow + " type='text' class='form-control PTKP text_input'>";
