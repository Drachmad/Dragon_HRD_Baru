				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control T_NIKAH_MATI rightJustified text-primary font-weight-bold" id="T_NIKAH_MATI" name="T_NIKAH_MATI" value="<?php echo number_format($row->T_NIKAH_MATI, 2, '.', ','); ?>" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
				...
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'</td>' +
							'<td><input name="NIKAH_MATI[]" onkeyup="hitung()" value="0" id=NIKAH_MATI' + i + ' type="text" class="form-control NIKAH_MATI rightJustified text-primary"></td>' +
