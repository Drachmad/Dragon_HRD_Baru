...
<div class="container-fluid">
	...
	<form id="premisablon" name="premisablon" action="<?php echo base_url('admin/Transaksi_Premi_Sablon/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td><input name="SABLON[]" onkeyup="hitung()" value="0" id="SABLON0" type="text" class="form-control SABLON rightJustified text-primary"></td>
								<td><input name="INJECT[]" onclick="select()" onkeyup="hitung()" value="0" id="INJECT0" type="text" class="form-control INJECT rightJustified text-primary"></td>
								<td><input name="LAIN1[]" onkeyup="hitung()" value="0" id="LAIN10" type="text" class="form-control LAIN1 rightJustified text-primary"></td>
								<td><input name="LUNAS_BS[]" onclick="select()" onkeyup="hitung()" value="0" id="LUNAS_BS0" type="text" class="form-control LUNAS_BS rightJustified text-primary"></td>
								...
								<td>
									...
									<input name="KAGRUP[]" onkeyup="hitung()" value="0" id="KAGRUP0" type="hidden" class="form-control KAGRUP rightJustified text-primary" readonly>
...
<script>
	...
	$(document).ready(function() {
		...
		for (i = 0; i <= jumlahdata; i++) {
			...
			$("#INJECT" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
			...
			$("#KAGRUP" + i.toString()).autoNumeric('init', {aSign: '<?php echo ''; ?>', vMin: '-999999999.99'});
		...
		$('body').on('click', '.select_kik_grup', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_Premi_Sablon/filter_kik_grup'); ?>',
				...
				// alert(response);
                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'<td><input name="SABLON[]" onclick="select()" onkeyup="hitung()" value="0" id=SABLON'+i+' type="text" class="form-control SABLON rightJustified text-primary"></td>'+
									'<td><input name="INJECT[]" onclick="select()" onkeyup="hitung()" id=INJECT'+i+' value="0" type="text" class="form-control INJECT rightJustified text-primary"></td>'+
									...
									'<td>'+
										...
										'<input name="KAGRUP[]" onkeyup="hitung()" value="0" id=KAGRUP'+i+' type="hidden" class="form-control KAGRUP rightJustified text-primary" readonly>'+
