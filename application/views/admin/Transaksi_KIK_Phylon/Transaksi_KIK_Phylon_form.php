...
<div class="container-fluid">
	...
	<form id="kikphylon" name="kikphylon" action="<?php echo base_url('admin/Transaksi_KIK_Phylon/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
