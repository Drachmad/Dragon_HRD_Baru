...
<div class="container-fluid">
	...
	<form id="kikstrong" name="kikstrong" action="<?php echo base_url('admin/Transaksi_KIK_Strong/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function tambah() {
		...
		td12.innerHTML = "<input type='hidden' name='NO_ID[]' id=NO_ID" + idrow + " value='0'  class='form-control'>" +
...
// NO_KIK
	function select_no_kik() {
		...
		$('.js-example-responsive-no_kik').select2({
			...
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_Strong/getDataAjax_KIK2') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
