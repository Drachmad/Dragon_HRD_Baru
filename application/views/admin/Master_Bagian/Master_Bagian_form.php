...
<div class="container-fluid">
	...
	<form id="form_master_customer" name="form_master_customer" action="<?php echo base_url('admin/Master_Bagian/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
        <br><br>
        <div class="form-body">
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="KD_BAG" name="KD_BAG" class="form-control text_input KD_BAG" required>
					</div>
					<div class="col-md-1">
						<label class="label">Nama Bagian</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="NM_BAG" name="NM_BAG" class="form-control text_input NM_BAG" required>
					</div>
					<div class="col-md-1">
						<label class="label">Prefix</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="PREFIX" name="PREFIX" class="form-control text_input PREFIX">
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="KD_KASI" name="KD_KASI" class="form-control text_input KD_KASI">
					</div>
					<div class="col-md-1">
						<label class="label">Nama Kasi</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="NM_KASI" name="NM_KASI" class="form-control text_input NM_KASI">
					</div>
                    <div class="col-md-1">
						<label class="label">Kode Grup</label>
					</div>
					<div class="col-md-3">
						<select class="js-example-responsive-kd_grup form-control text_input KD_GRUP" name="KD_GRUP" id="KD_GRUP" onchange="kd_grup(this.id)" required></select>
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="NM_GRUP" name="NM_GRUP" class="form-control text_input NM_GRUP" readonly>
					</div>
					<div class="col-md-1">
						<label class="label">Acno</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="ACNO" name="ACNO" class="form-control text_input ACNO" readonly>
					</div>
					<div class="col-md-1">
					...
					<div class="col-md-3">
						<select class="form-control text_input DR" name="DR" id="DR" style="width: 100%;" >
							<option value="I">Dragon 1</option> 
