...
<div class="container-fluid">
	...
	<form id="kikpsp" name="kikpsp" action="<?php echo base_url('admin/Transaksi_KIK_PSP/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
// NO_KIK
	function select_no_kik() {
		...
		$('.js-example-responsive-no_kik').select2({
			...
			ajax: {
				url: "<?= base_url('admin/Transaksi_KIK_PSP/getDataAjax_KIK2') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
