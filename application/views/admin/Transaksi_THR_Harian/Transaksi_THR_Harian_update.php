					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						?>
							<tr>
								...
								<td><input name="NM_PEG[]" id="NM_PEG<?php echo $no; ?>" value="<?= $row->NM_PEG ?>" type="text" class="form-control NM_PEG" required readonly></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_kd_bag', function() {
			...
			$.ajax({
				type:'get',
				url : '<?php echo base_url('index.php/admin/Transaksi_THR_Harian/filter_kd_bag'); ?>',
				data:{ kd_bag : kd_bag},
				dataType: 'json',
	...
	function tambah() {
		...
		td4.innerHTML = "<input name='PERB05[]' onclick='select()' onkeyup='hitung()' value='0' id=PERB05" + idrow + " type='text' class='form-control PERB05 rightJustified text-primary' readonly>";
		td5.innerHTML = "<input name='TOT_MS[]' onclick='select()' onkeyup='hitung()' value='0' id=TOT_MS" + idrow + " type='text' class='form-control TOT_MS rightJustified text-primary' readonly>";
		td6.innerHTML = "<input name='THR[]' onclick='select()' onkeyup='hitung()' value='0' id=THR" + idrow + " type='text' class='form-control THR rightJustified text-primary' readonly>";
		td7.innerHTML = "<input name='TAMBAH[]' onclick='select()' onkeyup='hitung()' value='0' id=TAMBAH" + idrow + " type='text' class='form-control TAMBAH rightJustified text-primary' readonly>";
