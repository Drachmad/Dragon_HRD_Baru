						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><input name="NM_PEG[]" id="NM_PEG<?php echo $no; ?>" value="<?= $row->NM_PEG ?>" type="text" class="form-control NM_PEG text_input" required readonly></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$('body').on('click', '.select_kd_bag', function() {
			...
			$.ajax({
				type: 'get',
				url: '<?php echo base_url('index.php/admin/Transaksi_UML_Borongan/filter_kd_bag'); ?>',
				data: {
					kd_bag: kd_bag
				},
				dataType: 'json',
				success: function(response) {
					...
					for (i = 0; i < response.length; i++) {
						html += '<tr>' +
							...
							'</td>' +
							'<td><input name="ULEMBUR[]" onkeyup="hitung()" value="' + numberWithCommas(response[i].ULEMBUR) + '" id=ULEMBUR' + i + ' type="text" class="form-control ULEMBUR rightJustified text-primary" readonly></td>' +
