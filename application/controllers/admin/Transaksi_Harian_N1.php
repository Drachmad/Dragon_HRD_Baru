...
class Transaksi_Harian_N1 extends CI_Controller
{
        ...
        foreach ($list as $hrd_absen) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_Harian_N1/update/' . $hrd_absen->no_id) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_Harian_N1/delete/' . $hrd_absen->no_id) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_Harian_N1()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $pt = $this->session->userdata['pt'];
        ...
        $this->load->view('admin/Transaksi_Harian_N1/Transaksi_Harian_N1', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_Harian_N1/Transaksi_Harian_N1_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        $bukti = 'HR' . $pr1 . '.' . $pr . '.' . $inisialpt . $fase . '-' . $kd_bag;
        $datah = array(
            'flag' => 'HR',
            'no_bukti' => $bukti,
            // 'kd_bag' => $this->input->post('KD_BAG', TRUE),
        ...
        redirect('admin/Transaksi_Harian_N1/index_Transaksi_Harian_N1');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_Harian_N1/Transaksi_Harian_N1_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update_aksi()
    {
        ...
        $this->session->set_flashdata(
            'pesan',
            '<div class="alert alert-success alert-dismissible fade show" role="alert"> Bukti ' . $this->input->post('NO_BUKTI') . ' Berhasil Di Update.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button> 
            </div>'
    ...
    function filter_kd_bag()
    {
        ...
        $q1 = "SELECT kd_peg AS KD_PEG, 
            ...
            FROM hrd_peg WHERE kd_bag='$kd_bag' 
            AND aktif='1'
            AND pt='$pt'
            AND cv='$cv'";
        $q2 = $this->db->query($q1);
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_Harian_N1.jrxml");
        $per = $this->session->userdata['periode'];
