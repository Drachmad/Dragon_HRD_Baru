...
class Transaksi_UML_Per_Jam extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->session->userdata['menu_hrd'] != 'hrd_lem') {
            ...
            $this->session->set_userdata('kode_menu', 'ST0021');
        ...
        foreach ($list as $hrd_lem) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_UML_Per_Jam/update/' . $hrd_lem->no_id) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_UML_Per_Jam/delete/' . $hrd_lem->no_id) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_UML_Per_Jam()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $pt = $this->session->userdata['pt'];
        ...
        $this->load->view('admin/Transaksi_UML_Per_Jam/Transaksi_UML_Per_Jam', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_UML_Per_Jam/Transaksi_UML_Per_Jam_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        if ($tgl->TGLCEK == 0) {
            ...
            redirect('admin/Transaksi_UML_Per_Jam/index_Transaksi_UML_Per_Jam');
        } else {
            $this->session->set_flashdata(
                'pesan',
                '<div class="alert alert-danger alert-dismissible fade show" role="alert"> 
    ...
    public function update($id)
    {
        ...
        $data['transaksi_uml_per_jam'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_UML_Per_Jam/Transaksi_UML_Per_Jam_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_UML_Per_Jam.jrxml");
        $no_id = $id;
