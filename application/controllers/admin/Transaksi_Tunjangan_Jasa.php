...
class Transaksi_Tunjangan_Jasa extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->session->userdata['menu_hrd'] != 'hrd_tunjang') {
            ...
            $this->session->set_userdata('kode_menu', 'ST0025');
        ...
        foreach ($list as $hrd_tunjang) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_Tunjangan_Jasa/update/' . $hrd_tunjang->no_id) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_Tunjangan_Jasa/delete/' . $hrd_tunjang->no_id) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_Tunjangan_Jasa()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $this->session->set_userdata('judul', 'Transaksi Tunjangan Jasa');
        $where = array(
            'dr' => $dr,
            'per' => $per,
            'flag' => 'JS'
        ...
        $this->load->view('admin/Transaksi_Tunjangan_Jasa/Transaksi_Tunjangan_Jasa', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_Tunjangan_Jasa/Transaksi_Tunjangan_Jasa_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        $datah = array(
            ...
            'tjasa' => str_replace(',', '', $this->input->post('TJASA', TRUE)),
            'dr' => $this->session->userdata['dr'],
            'per' => $this->session->userdata['periode'],
        ...
        $JASA = str_replace(',', '', $this->input->post('JASA', TRUE));
        $i = 0;
        foreach ($REC as $a) {
            $datad = array(
                'id' => $ID[0]->no_id,
        ...
        redirect('admin/Transaksi_Tunjangan_Jasa/index_Transaksi_Tunjangan_Jasa');
    }
    ...
    public function update($id)
    {
        ...
        $data['transaksi_tunjangan_jasa'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_Tunjangan_Jasa/Transaksi_Tunjangan_Jasa_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function getDataAjax_Pegawai()
    {
        ...
        $perPage = 10;
        $results = $this->db->query("SELECT no_id, nm_peg, kd_peg, dr
            FROM hrd_peg
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_Tunjangan_Jasa.jrxml");
        $no_id = $id;
        $query = "SELECT hrd_tunjang.no_id as ID,
                hrd_tunjang.no_bukti AS NO_BUKTI,
                hrd_tunjang.per AS PER,
                hrd_tunjang.tgl AS TGL,
                hrd_tunjang.tjasa AS T_JASA,
