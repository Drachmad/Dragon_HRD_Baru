...
class Transaksi_Tunjangan_Obat extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->session->userdata['menu_hrd'] != 'hrd_tunjang') {
            ...
            $this->session->set_userdata('kode_menu', 'ST0024');
        ...
        foreach ($list as $hrd_tunjang) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_Tunjangan_Obat/update/' . $hrd_tunjang->no_id) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_Tunjangan_Obat/delete/' . $hrd_tunjang->no_id) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_Tunjangan_Obat()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $this->session->set_userdata('judul', 'Transaksi Obat');
        $where = array(
            'dr' => $dr,
            'per' => $per,
            'flag' => 'OB'
        ...
        $this->load->view('admin/Transaksi_Tunjangan_Obat/Transaksi_Tunjangan_Obat', $data);
    ...
    public function input()
    {
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_Tunjangan_Obat/Transaksi_Tunjangan_Obat_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        $datah = array(
            ...
            'tobat' => str_replace(',', '', $this->input->post('TOBAT', TRUE)),
            'dr' => $this->session->userdata['dr'],
            'per' => $this->session->userdata['periode'],
        ...
        $OBAT = str_replace(',', '', $this->input->post('OBAT', TRUE));
        $i = 0;
        foreach ($REC as $a) {
            $datad = array(
                'id' => $ID[0]->no_id,
        ...
        redirect('admin/Transaksi_Tunjangan_Obat/index_Transaksi_Tunjangan_Obat');
    }
    ...
    public function update($id)
    {
        ...
        $data['transaksi_tunjangan_obat'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_Tunjangan_Obat/Transaksi_Tunjangan_Obat_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_Tunjangan_Obat.jrxml");
        $no_id = $id;
